...
// Inspired By: // © 2013 Brett Hewitt All Rights Reserved
...
public class gui : MonoBehaviour {
		 ...
		 * *******************************************/
			...
			if (accionActual != acciones.terceraPersona) {
				foreach (GameObject g in selectedManager.temp.objects)
				{
					...
					guiSelectedSize = 30;//Camera.main.GetComponent<mainCamera>().getScreenUnitSize ();
					Debug.Log ("Size: " + Camera.main.GetComponent<mainCamera>().getScreenUnitSize ());
	...
	public void saliendoTerceraPersona(GameObject manifestante) {
		...
		GameObject.Find("Control camara principal").transform.Translate(new Vector3(manifestante.transform.position.x, 
		                                                                             0, 
		                                                                            manifestante.transform.position.z),Space.World);
	}
